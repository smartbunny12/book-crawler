...
class BooksSpider(Spider):
    ...
    def close(self, reason):
        ...
        for row in csv_data:
            if row_count != 0:
                cursor.execute('INSERT IGNORE INTO books_table(ranting, product_type, upc, title) VALUES(%s, %s, %s, %s)', row)   # CREATE TABLE:books_table FIRST
            row_count += 1
